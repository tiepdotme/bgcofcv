module.exports = function(templateParams) {
    ...
    <img class="{{ include.class }}" alt="{{ include.alt }}" style="{{ include.style }}; object-fit: contain" srcset="{{ srcset }}" src="{{ selectedImage.src | absolute_url }}" sizes="(min-width: 300px) 50vw, 100vw" width="300">
    `;
    return template;
};
